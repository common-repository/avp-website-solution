<?php
/*
Plugin Name: AVP Website Solution
Description: Adds more security for your website. Server-side scanning. Performs deep website scans of all the files. Virus/Malware detection and removal. Bruteforce protection.
Version: 1.7.14
Author: eSoft Solutions
License: GPLv2
*/ 

if( is_admin() ) 
{
    function AVPWebSol17_plg_activation()
    {
    ...
    register_activation_hook( __FILE__, 'AVPWebSol17_plg_activation' );
}