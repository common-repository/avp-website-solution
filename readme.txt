...
Please note: Plugin sends and receives the data to API server.
...
A: Yes, we provide this kind of services. But it's not free. For more information please contact us
